...
& $taskPython -m PyInstaller --noconfirm --onedir --name airyview-pdf-helper --distpath artifacts/helper --workpath artifacts/helper-build --specpath artifacts --collect-all pyhanko --collect-all pyhanko_certvalidator src/pdf-helper/pdf_helper.py *> artifacts/helper-build.log
