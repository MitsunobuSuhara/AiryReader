...
key=rsa.generate_private_key(public_exponent=65537,key_size=2048);subject=x509.Name([x509.NameAttribute(NameOID.COMMON_NAME,'airyPDF TEST ONLY')]);now=datetime.datetime.now(datetime.timezone.utc)
